...
export default function AnalysisError({ error, onRetry }) {
  return (
    <FadeIn direction="scale">
      ...
      >
        ...
        <h1 className="text-xl font-bold text-slate-900 mb-2">Analysis Failed</h1>
        <p className="text-sm text-slate-500 leading-relaxed mb-2 max-w-[380px] mx-auto">{error.message}</p>
        <p className="text-[12.5px] text-slate-400 mb-8">
          Failed during: <span className="font-semibold text-slate-500">{error.stageLabel}</span>
        </p>
